...
**B.S., Computer Science** | *GPA: 3.67* |  *Expected May 2026* 
*  **Achievements:** Dean's List (Spring 2023, Fall 2023, Spring 2025, Fall 2025) 

---

## Technical Skills
*  **Languages:** Python, Java, C, JavaScript, TypeScript, SQL, HTML, CSS, YAML, MongoDB 
*  **Frameworks:** React, Node.js, Express, Flask, Jinja, Tailwind CSS, Framer Motion 
*  **Tools & Platforms:** Git, Docker, Linux, Vercel, Supabase, Kubernetes, Postman, IBM Code Engine, Azure 
*  **Concepts:** Data Structures & Algorithms, OOP, REST APIs, Machine Learning, CI/CD, Agile 

---

## Certifications
*  **IBM Full-Stack Development:** Coursera, 2026
 ...
 *Jan 2025 – Present*
*  Mentoring 150+ students across Fundamentals of CS, Computer Programming, and Pre-Calculus.
*  Leading weekly code reviews and problem-solving sessions, resulting in a 15% improvement in student exam performance.
*  Authored 10+ custom worksheets strengthening student mastery of Java basics and Object-Oriented Programming (OOP).
